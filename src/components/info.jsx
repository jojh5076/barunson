                ...
                <ul className={styles.info_list}>
                    <li>
                        <a href='http://www.barunn.net/' className={styles.info_img}>
                            <img src='/info/ban_brand_01.jpg' alt='Brand banner 1'/>
                        </a>
                    </li>
                    <li>
                        <a href='https://www.barunsoncard.com/brand/intro/brand.asp' className={styles.info_img}>
                            <img src='/info/ban_brand_02.jpg' alt='Brand banner 2'/>
                        </a>
                    </li>
                    <li>
                        <a href='http://www.barunn.net/' className={styles.info_img}>
                            <img src='/info/ban_brand_03.jpg' alt='Brand banner 3'/>
                        </a>
                    </li>
                    <li>
                        <a className={styles.info_img}>
                            <img src='/info/ban_brand_04_230209.jpg' alt='Brand banner 4'/>
                        </a>
                    </li>
                </ul>
          </div>
